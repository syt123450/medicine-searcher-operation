...
function findMedicineInfo($medicineName){
    $query = "SELECT m.medicineId, m.medicineName, m.price, b.brandName, f.factoryName, s.StoreName FROM Medicine m, Brand b, Factory f, Store s WHERE m.brandId = b.brandId AND b.factoryId =f.factoryId AND m.storeID = s.storeID AND medicineName like '%$medicineName%'";
